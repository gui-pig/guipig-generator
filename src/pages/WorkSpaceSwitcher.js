    ...
    new Workspace(this.state.selectedWorkspace.value).delete(() => {
      this.setState({
        workspaces: this.state.workspaces.filter(
          (workspace) => workspace.id !== this.state.selectedWorkspace.value
        ),
        selectedWorkspace: null,
      });
    });
  ...
  render() {
    ...
    return (
      <Grid container md={12} style={{ minHeight: "100vh" }}>
        <FormDialog
          ref={(i) => {
            if (null != i) this.triggerDialog = i.triggerDialog;
          }}
          title={"Add Workspace"}
          buttons={[
            {
        ...
        <Grid md={2} />
        <Grid md={8} container style={{ marginTop: "100px" }}>
          <Grid md={3} />
          <Grid md={6} container className={classes.container}>
            <Grid md={12}>
              ...
              <center>
                <img
                  src="../files/assets/images/guinea-pig.png"
                  style={{ maxWidth: "30%" }}
                  alt="logo.png"
                />
              </center>
            ...
            <Grid md={12} style={{ marginTop: "20px" }}>
              <Select
                ...
                options={this.state.workspaces.map((e) => {
                ...
                ? [
                    ...
                    <Grid md={6}>
                      <Button
                        ...
                        onClick={() => {
                          setActiveWorkSpace(
                            this.state.selectedWorkspace.value
                          );
